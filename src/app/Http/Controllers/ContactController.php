<?php
    ...
    class ContactController extends Controller
    {
        ...
        {
            // Get the most recently added contact for the current user
            $contact = Contact::where('user_id', Auth::id())
                              ->latest('id')  // Order by ID in descending order (newest first)
            ...
            if ($contact) {
                ...
                // If no contacts found, return a JSON response indicating no contacts
